    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
                        ...
                        <ul class="sidebar-menu mt-4 mb-4">
                            <li class="parent">
                                <a href="#" onclick="toggle_menu('dashboard'); return false" class=""><i class="fa fa-dashboard mr-3"> </i>
                                    <span class="none">Congé<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                </a>
                                <ul class="children" id="dashboard">
                                    <li class="child"><a href="" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Demande Congé</a></li>
                                    <li class="child"><a href="" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Consultation Etat Congé </a></li>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                <h5 class="mb-0" ><strong>Listes Des Employés</strong></h5>
                    ...
                    <div class="product-list">
                        ...
                        <div class="row border-bottom mb-4">
                            ...
                            <div class="col-sm-4 text-right pb-3">
                                  ...
                                  <!--<button class="btn btn-danger" data-toggle="modal" data-target="#orderUpdate"><i class="fas fa-trash"></i></button>
                                            <button class="btn btn-success"data-toggle="modal" data-target="#orderInfo" ><i class="fa fa-pencil"></i></button>-->
                                <!--<button type="button" class="btn btn-danger icon-round shadow pull-right">
                                    <i class="fas fa-trash"></i>
                                </button>
                                 <button type="button"  name=' btn' class='btn btn-danger' data-toggle='modal' data-target='#orderIn'class="btn btn-danger icon-round shadow pull-right">
                                   <i class="fas fa-user"></i>
                                </button>

                                 <button type="button"  name=' btn' class='btn btn-danger' data-toggle='modal' data-target='#orderR'class="btn btn-danger icon-round shadow pull-right">
                                   <i class="fas fa-search"></i>
                                </button>
                                

                                 
                               <button type="button"  name=' btn' class='btn btn-danger' data-toggle='modal' data-target='#orderInfo'class="btn btn-danger icon-round shadow pull-right">
                      ...
                      <%
                                ...
                                try{
                                    ...
                                    PreparedStatement ps1=con.prepareStatement("select * from etudiant");
                                    ResultSet rsi=ps1.executeQuery();
                                   
                                    ps1=con.prepareStatement("select count(*) from etudiant");
                                     rsi=ps1.executeQuery();
                                    rsi.next();
                                    nombre1=rsi.getInt(1);
                                    rsi.close();
                                    ps1.close();
                                    con.close();
                            ...
                            <table class="table table-bordered table-striped mt-3" id="productList">
                                ...
                                <td class="align-middle text-center">
                                         ...
                                         <button class="btn btn-danger" data-toggle="modal" data-target="#orderUpdate"><i class="fas fa-trash"></i></button>
                                         <a href="modetudiant.jsp"><button class="btn btn-success"data-toggle="modal" data-target="#orderInfo" ><i class="fa fa-pencil"></i></button></a>
                                        </td>
                                </tr>
                                      <%    
                                    }
        ...
        <!--Main Content-->
            ...
            <form class="form-horizontal mt-4 mb-5" action="Sevsuppetudiant" method="POST">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="row">Matricule</th><td class="align-middle"><input type="text" name="matricule"></td>  </tr>
                                                
                                                <tr> <th>Action</th><td align="center" style="width: 120px;" class="align-middle">

                                                      <button class="btn btn-danger" data-target="#orderUpdate"><i class="fas fa-trash"></i></button>
