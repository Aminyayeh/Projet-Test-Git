                ...
                <div class="row mt-3">
                    <div class="col-sm-12">
                        <!--Default elements-->
                          ...
                          <a href="affcher professeur.jsp"> <button class="btn btn-theme" data-toggle="modal" data-target="#orderInfo">
                                                <i class="fa fa-eye"></i>
                                </button></a>
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                        
                             
                            <form class="form-horizontal mt-4 mb-5" action="servajouterp" method="POST">
                                <div class="form-group row">

                                    <label class="control-label col-sm-2" for="input-1">ID</label>
                                    <div class="col-sm-10">
                                        <input type="number" name="matricule" class="form-control" id="input-1" placeholder="Id" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-2">Enseignants</label>
                                    <div class="col-sm-10">
                                    
                                  <select name="nom" class="form-control" id="input-3" >
                                          <option value="FAHMI">FAHMI</option>  
                                           <option value="KADER">KADER</option>  
                                            <option value="GINALEH">GINALEH</option>  
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Email</label>
                                    <div class="col-sm-10">
