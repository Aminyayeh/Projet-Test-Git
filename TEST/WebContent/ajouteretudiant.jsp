    ...
    <div class="container-fluid">
        ...
        <div class="row header shadow-sm">
            ...
            <div class="col-sm-3 pl-0 text-center header-logo">
               <div class="bg-theme mr-3 pt-3 pb-2 mb-0">
                    <h3 class="logo"><a href="#" class="text-secondary logo"><i class="fa fa-rocket"></i>AJOUTER EMPLOYES <span class="small"></span></a></h3>
               </div>
            </div>
            <!--Logo-->
        ...
        <div class="row main-content">
                        ...
                        <ul class="sidebar-menu mt-4 mb-4">
                            <li class="parent">
                                <a href="#" onclick="toggle_menu('dashboard'); return false" class=""><i class="fa fa-dashboard mr-3"> </i>
                                    <span class="none">Enregister un Employer<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                </a>
                                <ul class="children" id="dashboard">
                                    <li class="child"><a href="AjouterEmployer.html" class="ml-4"><i class="fa fa-angle-right mr-2"></i> Ajouter Employer</a></li>
                                     <li class="child"><a href="afficheremployer.php" class="ml-4"><i class="fa fa-angle-right mr-2"></i> Listes Des Employers </a></li>-->
                            ...
                            <li class="parent">
                                ...
                                <ul class="children" id="ul_element">
                                    <li class="child"><a href="AjouterFicherDeBaie.php" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Ajouter une Fiche de paie</a></li>
                                         <li class="child"><a href="afficherfiche.php" class="ml-4"><i class="fa fa-angle-right mr-2"></i> Listes de fiche de paie</a></li>-->
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                ...
                <h5 class="mb-0" ><strong>Ajouter Etudiant</strong></h5>
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                            ...
                            <form class="form-horizontal mt-4 mb-5" action="servajouter" method="POST">
                                <div class="form-group row">
                                    ...
                                    <label class="control-label col-sm-2" for="input-1">Matricule</label>
                                    <div class="col-sm-10">
                                        <input type="number" name="matricule" class="form-control" id="input-1" placeholder="Matricule " />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-2">Nom</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="nom" class="form-control" id="input-2" placeholder="Nom Etudiant" />
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Telephone</label>
                                    <div class="col-sm-10">
                                        <input type="number" name="telephone" class="form-control" id="input-3" placeholder="telephone" />
                                    </div>
                                </div>

                                 <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Classes</label>
                                
                                        <div class="col-sm-10">
                                    
                                  <select name="classe" class="form-control" id="input-3" >
                                         
                                            <option value="L3GI">L3GI</option>  
                                  ...
                                  <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Numero Tuteurs</label>
                                    <div class="col-sm-10">
                                        <input type="number" name="tuteur" class="form-control" id="input-3" placeholder="tuteurs" />
                                    </div>
                                </div>
